...
export const ScholarshipDetailsScreen: React.FC = () => {
  ...
  const handleToggleCompare = () => {
    ...
    setCompareFeedback(
      nextState
        ? `Added to comparison list (${comparedScholarshipIds.length + 1}/4).`
      ...
      <View className="mb-8 pt-2">
        <View className="flex-row gap-2 mb-2.5">
          ...
          <TouchableOpacity
            ...
            accessibilityLabel={isSaved ? 'Bookmarked' : 'Save scholarship'}
          ...
          <TouchableOpacity
            ...
            accessibilityRole="button"
            accessibilityLabel={isCompared ? 'In comparison' : 'Compare scholarship'}
            className={`flex-1 py-3 px-3 rounded-xl border flex-row items-center justify-center ${
              isCompared
