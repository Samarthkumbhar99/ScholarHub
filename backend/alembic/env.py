...
# Ensure all 15 domain models are explicitly imported so Base.metadata is populated
...
# Dynamically set sqlalchemy.url from application settings (preserves environment variable overriding)
